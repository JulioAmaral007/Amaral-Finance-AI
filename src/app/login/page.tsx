  ...
  return (
    <div className="grid min-h-dvh grid-cols-1 lg:grid-cols-2">
      ...
      <div className="mx-auto flex h-full w-full max-w-[550px] flex-col justify-center p-4 sm:p-8">
        <Image src="/logo.svg" width={173} height={39} alt="Finance AI" className="mb-6 sm:mb-8" priority />
        ...
        <button className="flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 sm:text-base">
